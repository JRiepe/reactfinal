				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement("input", { type: "text", className: "form-control text-center", id: "b_Year", onChange: this.handleChange }),
							React.createElement(
								"label",
								null,
								"Ending Year:"
							),
							React.createElement("input", { type: "text", className: "form-control text-center", id: "e_Year", onChange: this.handleChange }),
	...
	var Results = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'panel-body text-center', onClick: this.handleClick },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
		...
		getSaved: function getSaved() {
			...
			return axios.get('/saved').then(function (response) {
		...
		deleteSaved: function deleteSaved(id) {
			...
			return axios.delete('/saved', { _id: id }).then(function (results) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = (typeof window !== 'undefined' && window.btoa) || __webpack_require__(180);
						...
						React.createElement(
							...
							nytSaved.map(function (search, i) {
								...
								return React.createElement(
									...
									React.createElement(
										'button',
										{ id: search._id, onClick: this.handleClick },
										'Remove'
									)
								);
							})
